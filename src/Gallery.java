...
public class Gallery {
    ...
    public Gallery() {
        cars = new ArrayList<>();
        cars.add(new Car("Toyota", "Corolla", "C", "Hybrid", "Automatic", 5, 5, 1800, 2023, 4, 1500, 15, "White",1, false, false));
        ...
        cars.add(new Car("Nissan", "Juke", "D", "Hybrid", "Automatic", 5, 5, 2000, 2012, 4, 1500,15,"White",6, false, false));
        ...
        cars.add(new Car("Chevrolet", "Malibu", "D", "Petrol","Automatic", 7, 5, 2000, 2020, 4, 1500,15,"Purple",9, false, false));
        cars.add(new Car("Volkswagen", "Golf", "C", "Petrol", "Manual", 6, 5, 1800, 2021, 4, 870, 10, "Green",10, false, false));
        cars.add(new Car("Volkswagen", "Passat", "D", "Diesel", "Manual", 6, 5, 1800, 2023, 4, 1200, 15, "Black",11, false, false));
    ...
    public void addCar(Car car) {
        cars.add(car);
        System.out.println("Car added to the Gallery");
    }
